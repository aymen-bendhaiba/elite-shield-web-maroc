        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto animate-fade-in">
            <div className="text-center">
              ...
              <div className="font-roboto text-security-gold-light drop-shadow-lg">Années d'expérience</div>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center mb-3">
              ...
              <div className="font-roboto text-security-gold-light drop-shadow-lg">Clients protégés</div>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center mb-3">
              ...
              <div className="font-roboto text-security-gold-light drop-shadow-lg">Villes couvertes</div>
            </div>
          </div>
        </div>
      </div>
