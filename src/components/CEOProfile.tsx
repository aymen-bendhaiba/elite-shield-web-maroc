...
const CEOProfile = () => {
  ...
  const competencies = [
    { icon: Shield, text: "Close Protection Expertise", years: "18 ans" },
    { icon: Crown, text: "Executive Protection Specialist", years: "18 ans" },
    { icon: Users, text: "Manager of Security Teams", years: "15 ans" },
    { icon: Calendar, text: "Security Events Manager", years: "12 ans" },
    { icon: Target, text: "Supervisor of Security Groups", years: "10 ans" }
  ];
            ...
            <CardContent className="p-0">
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="bg-gradient-to-br from-security-gold/10 to-security-silver/10 p-8 lg:p-12 flex flex-col justify-center">
                  <div className="text-center mb-8">
                    ...
                    <div className="flex items-center justify-center mt-4 space-x-2">
                      ...
                      <span className="font-montserrat font-semibold text-security-gold">18 ans d'expérience</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center bg-security-dark/30 p-4 rounded-lg">
                      ...
                      <p className="font-roboto text-sm text-security-gold-light">Années Protection</p>
                    </div>
                    <div className="text-center bg-security-dark/30 p-4 rounded-lg">
                ...
                <div className="p-8 lg:p-12">
                  <div className="mb-8">
                    <h4 className="font-montserrat font-bold text-xl text-security-gold mb-4">Expérience Professionnelle</h4>
                    <div className="space-y-4">
                      <div className="border-l-2 border-security-gold pl-4">
                        ...
                        <p className="text-gray-300 text-sm">Protection de personnalités royales et officiels gouvernementaux - 18 ans</p>
                      </div>
                      <div className="border-l-2 border-security-gold pl-4">
                        <h5 className="font-roboto font-semibold text-white">Security Driver & Executive Protection Officer</h5>
                        <p className="text-gray-300 text-sm">Collaboration avec diverses compagnies de production cinématographique - 6 ans</p>
                      </div>
                    </div>
                  </div>

                  <div className="mb-8">
                    <h4 className="font-montserrat font-bold text-xl text-security-gold mb-4">Compétences Clés</h4>
